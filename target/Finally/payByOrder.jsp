...
<%@ page import="com.fx.alipayConfig.AlipayConfig2"%>
...
<%
	...
	String out_trade_no = (String) request.getSession().getAttribute("payOrderId");
	//付款金额，必填
	String total_amount = (String) request.getSession().getAttribute("payOrderMoney");
	//订单名称，必填
	String subject = (String) request.getSession().getAttribute("payOrderTitle");
	//商品描述，可空
	String body = "";
